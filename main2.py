...
def load_dataloader(n_train_rate, batch_size):
    data = load_data(kinds=["ADNI2"], classes=["CN", "AD"], unique=True, blacklist=True)
...
#    batch_size = 32
    print(f"batch size:{batch_size}") # plant-ai03  cpu数 = 24
...
def main():
    ...
    if args.model == "ResNetCAE":
        ...
        net = models.SoftIntroVAE(12, [[12,1,2],[24,1,2],[32,2,2],[48,2,2]])
        log_path = "./logs/" + args.log + "_VAEtoSoftVAE_fixed_seed/pram_test/"
